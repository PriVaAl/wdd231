document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!lastVisit) {
        // First visit message
        message.textContent = "Ready to become smarter?! Let us know if you have any questions.";
    } else {
        ...
        if (daysDifference < 1) {
            message.textContent = "Keep up the good work! Awesome!";
        } else {
            const dayWord = daysDifference === 1 ? "day" : "days";
            message.textContent = `We missed you! You last visited ${daysDifference} ${dayWord} ago.`;
        }
    }
